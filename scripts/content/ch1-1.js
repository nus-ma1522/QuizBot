const dialogueSystem = {
  ...
  p1: {
    type: "dialogue",
    content: "Do you still remember what that is called?",
    options: {
  ...
  p2: {
    type: "plain",
    content: "It's called a <b>linear equation</b>! It forms a straight line, with no curves, bends, breaks or whatsoever.<br>" +
    "You might also have recognized it as the equation of a line. Makes sense, right?",
    next: "def_linear_eqn"
  },
  ...
  p9: {
    ...
    systemMessage: "It's okay if you do not know how to solve linear systems yet. The detailed process will be covered in later sections."
  },
  ...
  p12: {
    ...
    systemMessage: "Note: Use the Desmos page to plot the new equations",
    next: "p13"
  },
  ...
  p25: {
    ...
    options: {
      ...
      1: "Express it as a combination of a valid point and a directional vector scaled by an unknown"
    },
    respondToIdx: {
      0: "p25r1",
      1: "p25r2"
  ...
  p29: {
    ...
    "is a valid solution?",
    options: {
      0: "Try to find a value of \\(s\\) that matches the point"
    },
    respondToIdx: {
      0: "p30"
    }
